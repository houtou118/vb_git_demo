...
void main(List<String> args) async {
  ...
  runner.argParser.addOption('char', abbr: 'c', help: 'The character to use for drawing');
...
String draw(int width, int height, String char, bool Function(double, double) pixel) {
